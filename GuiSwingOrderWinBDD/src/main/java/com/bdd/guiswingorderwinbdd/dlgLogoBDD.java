 ...
 * @author dan
 */
public class dlgLogoBDD extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(dlgLogoBDD.class.getName());

    /**
     * Creates new form dlgLogoBDD
     */
